...
def show_shopping_cart():
    ...
    if not "cart" in session:
        return render_template("cart.html", total_cost_of_order = 0, melons_list = [])
    ...
    for melon_id in cart:
        ...
        total_cost_of_order += melon.total
    ...
    return render_template("cart.html", total_cost_of_order = total_cost_of_order, melons_list = melons_list)
